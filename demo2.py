...
path_curr = os.getcwd()
path_results = path_curr + '/Training_Results/Results_Tetrapod_demo2/'

# path to experimental images
# path_exp_data = path_curr + '/Experimental_Data/Tetrapod_demo2_crop/'
path_exp_data = path_curr + '/Experimental_Data/one_image/'  # the image size should be smaller than H
