...
def demo1_parameters():
    ...
    # discretization in z
    D = 61  # in [voxels] spanning the axial range (zmax - zmin)
    ...
    training_data_path = path_curr_dir + "/Training_Data/TrainingImages_demo1/"
    ...
    results_path = path_curr_dir + "/Training_Results/Results_demo1/"
